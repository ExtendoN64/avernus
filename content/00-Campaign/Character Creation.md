...
Pick from the **27 custom backgrounds**. They replace the PHB versions. See **[[Backgrounds]]**.

Every background lets you **choose any two skills**; the ones listed are only suggestions. Tool proficiencies you take come with the tools, free.
...
You earn **inspiration** for playing your character's history and outlook, not for optimal tactics. Each background lists what specifically earns it.

You can hold **inspiration equal to your proficiency bonus**, so at level 1 that is two. Spend it.

## Levelling

We start at **level 1**. Hit points are max at first level. See [[House Rules]] for the rest.

## See also

[[Backgrounds]] · [[Starting Equipment]] · [[Homebrew]] · [[House Rules]] · [[Campaign Primer]] · [[Safety Tools]]
