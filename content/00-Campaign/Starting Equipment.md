...
From **[ManBat's House-Rules](https://docs.google.com/document/d/1PYAOb6NtrI53YKhW835HCzMt_QlHlwzRRsXxt--TvBk/edit?usp=sharing)**. More generous than the PHB, and you get it **in addition to** whatever your [[Backgrounds|background]] grants.
...
- One simple weapon, one sidearm pistol and 10 rounds
- A hand cannon and 10 rounds, **or** a martial melee weapon
- Studded leather **or** scale mail
- A blacksmith's, burglar's, **or** demolitionist's pack
...
- Studded leather **or** scale mail
- A soldier's, monster hunter's, **or** urchin's pack
...
### Fighter
- Ring mail, **or** a chain shirt with a longbow and 10 arrows
- A martial weapon and shield, **or** two martial weapons
- Light crossbow and 10 bolts, **or** two handaxes
...
- A shortbow and 10 arrows, **or** 20 darts
- A priest's, hermit's, **or** explorer's pack
- A holy symbol **or** a musical instrument

### Paladin
- A martial weapon and a shield, **or** two martial weapons
- A simple melee weapon **or** five javelins
- A priest's, soldier's, **or** squire's pack
...
### Runekeeper
- A light crossbow and 10 bolts, **or** a simple weapon
...
- A diplomat's, explorer's, **or** urchin's pack

### Vanguard
- A shield **or** a tower shield
- A blacksmith's, soldier's, **or** squire's pack
...
- A component pouch **or** an arcane focus
- An astronomer's, scholar's, **or** dungeoneer's pack
...
You can also buy any of these outright at the price shown.

| Pack | Cost | Contents |
|---|---|---|
| **Astronomer's** | 45 gp | Astrolabe, backpack, hammock, ink, ink pen, parchment (10), scroll case of celestial diagrams, telescope, rations (5 days), waterskin |
...
| **Entertainer's** | 35 gp | Backpack, basic oil (3), bedroll, bell, bullseye lantern, costumes (3), rations (5 days), steel mirror, tinderbox, waterskin |
| **Explorer's** | 17 gp | Backpack, blanket, caltrops (20), common wine, mess kit, pitons (4), pouch, rations (5 days), signal whistle, silk rope (50 ft), soap, string (10 ft), torches (5), trinkets (2d4), waterskin |
| **Hermit's** | 44 gp | Backpack, basic oil (2), blanket, book, calligrapher's supplies (or painter's supplies or potter's tools), hooded lantern, mess kit, mortar and pestle, rations (5 days), trinkets (2), waterskin |
| **Mediciner's** | 22 gp | Backpack, flasks (3), glass bottles (5), hammock, healer's kit, herbalism kit, rations (10 days), waterskin |
| **Monster Hunter's** | 33 gp | Basic oil, chest, crowbar, hammer, holy symbol, holy water, manacles, steel mirror, wooden stakes (3), tinderbox, torches (3) |
...
## New and changed gear

### Weapon properties you will not know

- **Heavy (X).** Disadvantage on attack rolls unless your Strength is at least X. This replaces the PHB version, and it applies to everyone rather than only Small creatures. A greataxe is **Heavy (15)**.
- **Kick (X).** Usable in one or two hands. Disadvantage on ranged attacks one handed unless your Strength is at least X.
- **Loud.** The shot is audible out to 300 feet.
- **Pocket.** Advantage on Sleight of Hand checks to conceal it.
- **Reload (X).** Fires X times before reloading. Reloading costs an action or a bonus action and needs a free hand.
- **Fist.** You may deal this weapon's damage instead of your normal unarmed strike damage.

### Notable weapons

| Weapon | Cost | Damage | Properties |
|---|---|---|---|
| Brass knuckles | 1 gp | 1d4 bludgeoning | Fist, light |
| Katar | 3 gp | 1d4 piercing | Fist, light |
| Trench knife | 3 gp | 1d4 slashing | Fist, light |
| Stiletto dagger | 8 gp | Heads 4 / tails 1 piercing | Finesse, light, pocket |
| Parrying dagger | 15 gp | 1d4 piercing | Finesse, light, special |
| Katana | 50 gp | 1d6 slashing | Finesse, versatile (1d8) |
| Bastard sword | 65 gp | 1d10 slashing | Heavy (17), versatile (1d12) |
| Greatsword | 30 gp | **2d4** slashing | Heavy (15), two handed |
| Maul | 10 gp | **2d4** bludgeoning | Heavy (15), two handed |
| Pike | 5 gp | 1d10 piercing | Heavy (13), reach, two handed |
| Light crossbow | 25 gp | **1d8** piercing | Ammunition (80/320), reload (1), two handed |
| Heavy crossbow | 50 gp | 1d12 piercing | Ammunition (100/400), heavy (11), reload (1), two handed |

**Parrying dagger:** when attacked in melee while wielding it, use your reaction for **+2 AC** against that attack.

> [!warning] Greatsword and maul are 2d4, not 2d6
> That is a real change and it is easy to miss. Average damage drops from 7 to 5.

### Firearms

The weapon list includes **sidearm pistols, hand cannons, repeating rifles and shotguns**, and both the **Gunslinger** class and the **Artificer** starting kit assume them.

| Firearm | Cost | Damage | Properties |
|---|---|---|---|
| Sidearm pistol | 50 gp | 1d6 piercing | Ammunition (40/120), loud, pocket, reload (6) |
| Hand cannon | 85 gp | 1d8 piercing | Ammunition (60/180), kick (12), loud, reload (6) |
| Repeating rifle | 90 gp | 1d10 piercing | Ammunition (150/450), loud, reload (6), two handed |
| Sawed off shotgun | 85 gp | 1d10 piercing | Ammunition (10/20), kick (14), loud, reload (2), special (1d12) |
| Repeating shotgun | 140 gp | 2d4 piercing | Ammunition (20/30), loud, reload (6), special (2d6), two handed |

**Shotguns** deal their higher damage die against a target within 10 feet.

> [!warning] DECIDE: are guns in Baldur's Gate?
> This is a setting call rather than a balance one. Firearms on the Sword Coast are usually rare, Gondian, and closely held, which is a very different thing from a gunslinger walking into the Elfsong with a rifle on their back.
>
...
| Hide (medium) | 10 gp | 12 + Dex (max 3) | Dex cap is 3, not 2 |
| Ring mail (heavy) | 30 gp | 15 | Stealth disadvantage |
| Lamellar (heavy) | 3,000 gp | **18** | Str 15 |
| Shield | 10 gp | +2 | |
| Tower shield | 70 gp | +2 | Str 15, heavy (15), two handed, **grants half cover** |

## Crafting

You can craft nonmagical items with tools you are proficient in, spending downtime and raw materials worth **half** the item's market value.
...
**Alchemy** has its own rules. See [[Homebrew]].

## See also

[[Character Creation]] · [[Backgrounds]] · [[Homebrew]] · [[House Rules]]
